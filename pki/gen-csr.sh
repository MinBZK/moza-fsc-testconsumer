...
# Materialiseert de per-endpoint csr.json's van de ZAD-peer `uitvraag-org`
# (pki/peers/uitvraag-org/<endpoint>/csr.json) uit de ZAD-topologie-env-vars, zodat een PROJECT- of
...
# bepaalt de uitvoer-volgorde; spiegelt de UVR*_SVC-namen in upsert-peer.sh.
